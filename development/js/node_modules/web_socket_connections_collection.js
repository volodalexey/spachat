...
var Web_socket_connections_collection = function() {
    ...
    this.msgMap = {
        create_chat: this.chats_message_router.onDeviceCreateChat,
        chat_join: this.chats_message_router.onDeviceChatJoin,
        chat_offer: this.chats_message_router.onDeviceChatOffer,
        chat_answer: this.chats_message_router.onDeviceChatAnswer,
        chat_accept: this.chats_message_router.onDeviceChatAccept,
        user_add: this.users_message_router.onDeviceAddUser,
        user_toggle_ready: this.users_message_router.onDeviceToggleReady
    };

    this.contextMap = {
        create_chat: this.chats_message_router,
        chat_join: this.chats_message_router,
        chat_offer: this.chats_message_router,
        chat_answer: this.chats_message_router,
        chat_accept: this.chats_message_router,
...
Web_socket_connections_collection.prototype = {
    ...
    get_wsc_by_tmp_dev_id: function(ws_device_id) {
        var target_wsc = null;
        this.get_all_wsc().forEach(function(wsc) {
